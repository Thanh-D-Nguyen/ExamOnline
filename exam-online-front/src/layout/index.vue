				...
				<el-row type="flex" justify="space-between">
					...
					<el-menu :default-active="activeIndex" class="el-menu-title" mode="horizontal" @select="handleSelect"
					 background-color="#ffffff" text-color="#85baef" active-text-color="#1884f2" :router="true">
						<el-menu-item index="/exam">examination centre</el-menu-item>
						<el-menu-item index="/practice">Simulation exercise</el-menu-item>
						<el-menu-item index="/grade">Query score</el-menu-item>
						<el-menu-item index="/mistake" disabled>Wrong question book</a></el-menu-item>
					</el-menu>
					<el-dropdown>
						...
						<el-dropdown-menu slot="dropdown">
							<el-dropdown-item>
								<el-button type="text" @click="toCenter">Personal center</el-button>
							</el-dropdown-item>
							<el-dropdown-item>
								<el-button type="text" @click="toUpdatePwd">change Password</el-button>
							</el-dropdown-item>
							<el-dropdown-item divided>
								<el-button type="text" @click="loginOut">sign out</el-button>
							</el-dropdown-item>
						</el-dropdown-menu>
					</el-dropdown>
				</el-row>
